...
#     key_path_extra = 'C:\\Users\\kalmukds\\NOTEBOOKs\\projects\\keys\\other_keys.json'
    ...
    def create_table_query(self, df, table_name, partition = 'date', nullable = True):
        for col in df:
...
PARTITION BY {partition} ORDER BY {partition}'''
    ...
    def creat_table_df(self, df, table_name, partition = 'date', nullable = True):
        res1 = self.create_table_query(df,table_name,partition , nullable )
